Public Class Form1
    ...
    Private Sub Button1_Click_1(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        ' PYEI
        If RadioButton1.Checked = True AndAlso selectedDate.DayOfWeek >= DayOfWeek.Monday AndAlso selectedDate.DayOfWeek <= DayOfWeek.Thursday And (timeIn >= startTime_pyei) Then
